...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { Title: @marker.Title, lat: @marker.lat, lon: @marker.lon } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { Title: @marker.Title, lat: @marker.lat, lon: @marker.lon } }
